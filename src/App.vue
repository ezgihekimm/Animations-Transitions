      ...
      <nav class="navbar navbar-dropdown collapsed">
        <div class="container-fluid">
          <div class="navbar-brand">
            ...
            <span class="navbar-caption-wrap"><a class="navbar-caption text-warning display-7"
                href="#">CoLighting</a></span>
          </div>
          <div class="contacts_menu display-4">
            <ol>
              <li><a href="tel:1234567890" class="text-warning">+90 212 381 0970</a></li>
              <li><a href="mailto:support@mobirise.com" class="text-warning">baumind.com.tr</a></li>
            </ol>
          </div>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
              <li class="nav-item"><a class="nav-link link text-warning display-4" href="index.html#top">Home</a></li>
              <li class="nav-item" style="
"><a class="nav-link link text-warning text-primary display-4" href="index.html#features9-3">Specifications</a></li>
             
              <li class="nav-item"><a class="nav-link link text-warning text-primary display-4"
                  href="index.html#features7-7">Services</a></li>
              <li class="nav-item"><a class="nav-link link text-warning text-primary display-4"
                  href="index.html#gallery1-d">Showcase</a></li>
              <li class="nav-item"><a class="nav-link link text-warning text-primary display-4"
                  href="index.html#features8-5">Our Works</a></li>
            </ul>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-lg">
            <div class="content_box">
              ...
              <p class="mbr-text mbr-fonts-style display-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Earum quia sit necessitatibus quasi, perspiciatis animi exercitationem assumenda delectus, magnam rerum
                vero. Distinctio dolores alias vero ut consequatur quasi ad quas?</p>
              <p class="linkBtn mb-0 mbr-fonts-style display-7"><a href="index.html" class="text-warning">Learn More</a>
              </p>
            </div>
          </div>
        ...
        <div class="row justify-content-center">
          <div class="card col-12 col-lg">
            <div class="card-wrapper">
              ...
              <p class="mbr-text mb-0 mbr-fonts-style display-5">Lorem ipsum dolor sit amet consectetur adipisicing
                elit. Optio, atque. Praesentium itaque saepe aliquam? Quaerat quasi veniam, quia, autem neque impedit.
              </p>
              <div class="list_box">
        ...
        <div class="main_header">
          <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-12 align-center">
              ...
              <h3 class="mbr-section-title mb-0 mbr-fonts-style ls-1 display-1">USAGE AREAS</h3>
            ...
            <div class="item-wrapper">
              <div class="card-box">
                ...
                <p class="card-text mbr-fonts-style display-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Vel laudantium odit ducimus doloribus. Est, nesciunt.</p>
                <p class="linkBtn mb-0 mbr-fonts-style display-7"><a href="index.html" class="text-primary">View
                    More</a></p>
              </div>
            </div>
          </div>
            ...
            <div class="item-wrapper">
              <div class="card-box">
                ...
                <p class="card-text mbr-fonts-style display-4">Lorem ipsum dolor, sit, amet consectetur adipisicing
                  elit. Ex animi ullam, possimus tenetur.</p>
                <p class="linkBtn mb-0 mbr-fonts-style display-7"><a href="index.html" class="text-primary">View
                    More</a></p>
              </div>
            </div>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          ...
          <div class="title col-md-12 col-lg-10">
            ...
            <p class="mbr-text ls-1 mb-0 mbr-fonts-style display-2">Have you ever wanted to impress your audience at
              first sight? Our studio uses modern technologies and extensive opportunities for photo and video shooting
              in action. We work with ambitious brands to create a meaningful image so that you can make the best
              impression.
            </p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-12 col-md-10 col-lg-7 col-xl-5">
            <div class="mbr-section-head">
              <h3 class="mbr-section-title mbr-black mbr-fonts-style mb-0 display-5">The hassle-free design starts here
              </h3>
              <h4 class="mbr-section-subtitle mbr-fonts-style display-4">Subscribe to newsletter</h4>
              <p class="mbr-text mbr-black mbr-fonts-style display-4">Lorem ipsum dolor sit amet, consectetur
                adipisicing elit. Ab quas deleniti nihil, porro nulla, atque dicta placeat architecto ratione delectus,
                voluptas, reiciendis quo laboriosam voluptatum ad quasi hic recusandae laudantium dolore. Repellat sit
                provident quae consequatur facilis eum eveniet nobis molestias.<br><br>Nihil quia quas quaerat natus eos
                delectus culpa nulla tempore ipsa ad libero nesciunt asperiores cum earum odio similique dolore.
                Voluptate minus atque nostrum, nobis totam fuga, aperiam quis.</p>
            </div>
            ...
            <div class="mbr-form form_box" data-form-type="formoid">
              ...
              <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler"
                data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true"
                  value="Ya72rr3fhKhy87Ro2Oq1+BNe4z0+IDNZAR3iJvbkEy3fIKu3qxqOiCRscm8tFYjSVV9DW7W75Udx5jaux2gRaBgxv56lfuokI1m8YFE9lgRbRJj1csNpjITz2xkY0OZy.pkfLh9gKO8KXxi/5IyypzjQSxEyAmX1qUcHlDBnDRwzKKGh3pnyMz2N7ar2vf4ouLMRYFIsd6xdO80wqXHfcFkVaf8Jbyy+9MKb4epsWnQ+dzwA4R9NShjo8hT4fxfRT">
                <div class="row">
                ...
                <div class="dragArea row">
                  ...
                  <div data-for="email" class="col-lg-8 col-md-8 col-sm-12 form-group">
                    <input type="email" name="email" placeholder="Your email address..." data-form-field="email"
                      class="form-control display-7" value="" id="email-form2-8">
                  </div>
                  <div class="col-lg-4 col-md-4 col-sm-12 mbr-section-btn"><button type="submit"
                      class="btn btn-white display-4">Subscribe</button></div>
                </div>
              </form>
              <!--Formbuilder Form-->
            </div>
        ...
        <div class="main_header">
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-6 offset-md-1">
              <div class="content_box">
                <p class="mbr-text mbr-fonts-style display-7">Lorem, ipsum dolor sit, amet consectetur adipisicing elit.
                  Sint quasi perferendis cum tempore placeat necessitatibus odit totam reiciendis, mollitia repellat
                  ipsum aut consequuntur ipsam voluptatem delectus distinctio ea deserunt natus.</p>
        ...
        <div class="row">
          <div class="col-12 col-md-12 col-lg-7">
            ...
            <ul class="foot-menu">
              ...
              <li class="foot-menu-item mbr-fonts-style display-7"><a href="index.html#features8-5"
                  class="text-warning">Works</a></li>
            </ul>
          </div>
          <div class="col-12 col-md-12 col-lg-5">
            <div class="box">
              ...
              <ul class="foot-contacts">
                ...
                <li class="foot-mail mbr-fonts-style display-7">
