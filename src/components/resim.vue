        ...
        <div class="main_header">
          <div class="row justify-content-center">
            <div class="col-12 col-md-12 col-lg-12 align-center">
              ...
              <h5 class="mbr-section-title mb-5 mt-o mbr-fonts-style ls-1 display-2 " style="font-family: 'Roboto', sans-serif; color:#C4E5F6">
TECHNICAL PARTS</h5>
      ...
      <div class="container-fluid">
        ...
        <div class="row no-gutters">
          ...
          <div class="card_item col-12 col-md-6 col-lg-3 mt-4">
